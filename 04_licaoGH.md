Lição GitHub nº 04
================
Jeovane borges silva dos santos </br>
Estat 2020.2
...
são qualitativas (categóricas)?</br> *Resp.* As variáveis numéricas são
idade,pais filho,conjuge irmão, preço da passagem,cabine,classe. As
variáveis categóricas são nome,sexo,sobreviveu,porto embarque,passagem.
...
Quanto você estimaria de mortes e sobrevivência?</br> *Resp.*Houve
61,62% de mortes, 38,38% de sobrevivêntes.(usando regra de 3)
...
pelo fato de ter uma quantidade maior de homens
...
Na 3⁰ classe houve mais 60% de mortes, sendo a classe que sofreu mais
mortes. 2⁰ classe houve 50% de sobreviver ou morrer. 1⁰ classe houve
mais de 60% de sobrevivente.
...
passageiros, em relação à sua sobrevivência ou não? </br> *Resp.* O
gráfico mostra que as maior parte dos passageiros que morreram tinham
mais de 28anos \#\# 4. Para pensar e responder
...
anos (incluíndo esses extremos)? </br> *Resp.* alculando o valor do 1⁰
quadril (Q1) **Questão 10.** Qual outra curiosidade você desejaria saber
sobre esse conjunto de dados? Proponha uma questão que não tenha sido
abordada nas perguntas anteriores e, em seguida, responda-a utilizando o
`R`. **Qual País teve o maior numero de mortos?**
...
![](04_licaoGH_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->

O gráfico mostra que Southampton teve o maior número de passageiros e
por esse fato também teve o maior número de mortos..
